...
class BaseService {
    ...
    find(name, query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db[name].findOne(query);
    ...
    */
    create(name, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db[name].create(data);
            // ToDo: Espacio para auditoria
        });
    }
    /**
    ...
    update(name, data, query) {
        return __awaiter(this, void 0, void 0, function* () {
            if (data === null || data === void 0 ? void 0 : data.Id)
                delete data.Id;
            return yield this.db[name].update(data, query);
            // ToDo: Espacio para auditoria
        });
    }
    /**
    ...
    delete(name, query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db[name].destroy(query);
            // ToDo: Espacio para auditoria
        });
    }
}
